# =========================================================
# [脚本说明]
# 用途：对 185-195 mm 区间的数据做局部宽度提取和线性拟合，并输出带公式与 R² 标注的图。
# 输入：1. 扫描文件夹并筛选目标位置范围文件。
# 输出：2. 用 `estimate_period` 估周期，用互相关在受限范围找相位位移，再做差分与 FFT 主频提取宽度。
# =========================================================
...
# ???185-195mm ???????????
# ???????? CSV ???
# ???????? linear_fit_final_annotated.png?
# =========================================================
